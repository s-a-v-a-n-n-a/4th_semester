...
public:
	...
	Button *create_sort_button(const Vector_ll &position, const Vector_ll &size, const char *name, const Color &color, Int_container *array, void (*sort)(void *, size_t, size_t, int(*cmp)(const void *, const void *)));
	...
	Button *create_refill_button(const Vector_ll &position, const Vector_ll &size, const char *name, const Color &color, Bar_graph *graph, Int_container *array);
